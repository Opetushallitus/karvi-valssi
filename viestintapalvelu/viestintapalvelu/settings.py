...
from viestintapalvelu.filters import DisableLoggingInTestingFilter, AddProgramnameFilter
...
def get_test_db_name():
    ...
    return "aa_vies_" + md5.hexdigest()[:8]
...
EMAIL_URL_BASE = os.getenv("EMAIL_URL_BASE", "https://viestinvalitys.testiopintopolku.fi")
EMAIL_SERVICE_NAME = "viestinvalitys-service"
EMAIL_SERVICE_URL = f"{EMAIL_URL_BASE}/lahetys/v1"
EMAIL_SERVICE_TIMEOUT = int(os.getenv("EMAIL_SERVICE_TIMEOUT", 5))  # seconds
EMAIL_SERVICE_EMAIL_STORAGE_PERIOD = 365  # days
EMAIL_SERVICE_EMAIL_SENDING_SERVICE = "valssi"
EMAIL_SERVICE_SESSION_COOKIE_RENEWAL_INTERVAL = 10  # minutes
EMAIL_SERVICE_PERMISSION_ORG = "1.2.246.562.10.12218193316"  # Karvi oid
EMAIL_SERVICE_PERMISSION = "APP_VALSSI_YLLAPITAJA"

EMAIL_FROM_ADDRESS = os.getenv("EMAIL_FROM_ADDRESS", "noreply@opintopolku.fi")
EMAIL_FROM_NAME = os.getenv("EMAIL_FROM_NAME", "Karvi Valssi")
