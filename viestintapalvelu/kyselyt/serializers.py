...
from kyselyt.constants import VASTAAJATUNNUS_MAX_LENGTH, EMAIL_STATUS_SENT, EMAIL_STATUS_FAILED, DATE_INPUT_FORMAT
...
class MessagePostSingleSerializer(serializers.ModelSerializer):
    ...
    end_date = serializers.DateField(required=True, input_formats=[DATE_INPUT_FORMAT])
...
class MessagePostSerializer(serializers.Serializer):
    ...
    filename_en = serializers.CharField(required=False, allow_blank=True)
    ...
    pdf_file_en = serializers.FileField(required=False, allow_empty_file=True)
