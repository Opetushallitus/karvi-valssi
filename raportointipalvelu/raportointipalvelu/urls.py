...
router_v1.register(
    r"available-kyselykertas", views.AvailableKyselykierrosListViewset, basename="available-kyselykertas"
)
router_v1.register(r"answers-export", views.AnswersExportViewset, basename="answers-export")
router_v1.register(r"lomake-usage-export", views.LomakeUsageExportViewset, basename="lomake-usage-export")
