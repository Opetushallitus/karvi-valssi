...
class ErrorMessages(enum.Enum):
    ...
    ER028 = get_error_dict("ER028", "Oppilaitos doesn't match with koulutustoimija.")
    ER029 = get_error_dict("ER029", "Kysely is still active.")
    ER030 = get_error_dict("ER030", "Kysymysryhma laatutekija not allowed.")
    ER031 = get_error_dict("ER031", "There is no Kysely with given kysymysryhmaid and voimassa_alkupvm.")
    ER032 = get_error_dict("ER032", "Faulty date format.")
    ER033 = get_error_dict("ER033", "Only pvm1<=pvm2 is allowed.")
    ER034 = get_error_dict("ER034", "Language code is not allowed within Kysymysryhma.")
