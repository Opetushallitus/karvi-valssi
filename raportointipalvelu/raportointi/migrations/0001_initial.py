# Generated by Django 4.0.7 on 2022-09-26 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_oid', models.ForeignKey(blank=True, db_column='parent_oid', null=True,
                                                 on_delete=django.db.models.deletion.DO_NOTHING,
                                                 to='raportointi.organisaatio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('koulutustoimija',
                 models.ForeignKey(db_column='koulutustoimija', on_delete=django.db.models.deletion.DO_NOTHING,
                                   related_name='kysely_koulutustoimija', blank=True, null=True,
                                   to='raportointi.organisaatio')),
                ('oppilaitos', models.ForeignKey(db_column='oppilaitos', on_delete=django.db.models.deletion.DO_NOTHING,
                                                 related_name='kysely_oppilaitos', blank=True, null=True,
                                                 to='raportointi.organisaatio')),
                ('luotuaika', models.DateTimeField(auto_now_add=True)),
                ('muutettuaika', models.DateTimeField(auto_now=True)),
                ('nimi_en', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kyselyid', models.ForeignKey(db_column='kyselyid', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kysely')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kyselykerta_muutettu_kayttaja', to='raportointi.kayttaja')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kutsumanimi', models.CharField(blank=True, max_length=50, null=True)),
                ('sukunimi', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vastaajaid', models.ForeignKey(db_column='vastaajaid', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.vastaaja')),
            ],
            options={
                'db_table': 'vastaus',
                'managed': settings.TESTING,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metatiedot', models.JSONField(blank=True, null=True)),
                ('kyselykertaid', models.ForeignKey(db_column='kyselykertaid', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kyselykerta')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='vastaajatunnus_muutettu_kayttaja', to='raportointi.kayttaja')),
                ('tutkintotunnus', models.ForeignKey(blank=True, db_column='tutkintotunnus', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.tutkinto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metatiedot', models.JSONField(blank=True, null=True)),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysymysryhma_muutettu_kayttaja', to='raportointi.kayttaja')),
                ('tila', models.ForeignKey(blank=True, db_column='tila', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.tilaenum')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jatkokysymysid', models.ForeignKey(db_column='jatkokysymysid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysymysjatkokysymys_jatkokysymysid', to='raportointi.kysymys')),
                ('kysymysid', models.ForeignKey(db_column='kysymysid', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kysymys')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='kysymys',
            name='kysymysryhmaid',
            field=models.ForeignKey(db_column='kysymysryhmaid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysymykset', to='raportointi.kysymysryhma'),
        ),
        migrations.AddField(
            model_name='kysymys',
            name='luotu_kayttaja',
            field=models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja'),
        ),
        migrations.AddField(
            model_name='kysymys',
            name='muutettu_kayttaja',
            field=models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysymys_muutettu_kayttaja', to='raportointi.kayttaja'),
        ),
        migrations.CreateModel(
            name='Kyselypohja',
            fields=[
                ...
                ('metatiedot', models.JSONField(blank=True, null=True)),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kyselypohja_muutettu_kayttaja', to='raportointi.kayttaja')),
                ('tila', models.ForeignKey(blank=True, db_column='tila', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.tilaenum')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='kysely',
            name='kyselypohjaid',
            field=models.ForeignKey(blank=True, db_column='kyselypohjaid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kyselypohja'),
        ),
        migrations.AddField(
            model_name='kysely',
            name='luotu_kayttaja',
        ...
        migrations.AddField(
            model_name='kysely',
            name='muutettu_kayttaja',
            field=models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysely_muutettu_kayttaja', to='raportointi.kayttaja'),
        ),
        migrations.AddField(
            model_name='kysely',
            name='tila',
            field=models.ForeignKey(blank=True, db_column='tila', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.tilaenum'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kysymysid', models.ForeignKey(db_column='kysymysid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='monivalintavaihtoehdot', to='raportointi.kysymys')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='monivalintavaihtoehto_muutettu_kayttaja', to='raportointi.kayttaja')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('kysymysryhmaid', models.OneToOneField(db_column='kysymysryhmaid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='raportointi.kysymysryhma')),
                ('jarjestys', models.IntegerField()),
                ('luotuaika', models.DateTimeField()),
                ('muutettuaika', models.DateTimeField()),
                ('kyselypohjaid', models.ForeignKey(db_column='kyselypohjaid', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kyselypohja')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysymysryhmakyselypohja_muutettu_kayttaja', to='raportointi.kayttaja')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('kysymysryhmaid', models.ForeignKey(db_column='kysymysryhmaid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='raportointi.kysymysryhma')),
                ('jarjestys', models.IntegerField(blank=True, null=True)),
                ('luotuaika', models.DateTimeField(auto_now_add=True)),
                ('muutettuaika', models.DateTimeField(auto_now=True)),
                ('kyselyid', models.ForeignKey(db_column='kyselyid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kysymysryhmat', to='raportointi.kysely')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kyselykysymysryhma_muutettu_kayttaja', to='raportointi.kayttaja')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='KyselyKysymys',
            fields=[
                ('kysymysid', models.OneToOneField(db_column='kysymysid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='raportointi.kysymys')),
                ('luotuaika', models.DateTimeField()),
                ('muutettuaika', models.DateTimeField()),
                ('kyselyid', models.ForeignKey(db_column='kyselyid', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kysely')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
                ('muutettu_kayttaja', models.ForeignKey(db_column='muutettu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, related_name='kyselykysymys_muutettu_kayttaja', to='raportointi.kayttaja')),
            ],
            options={
