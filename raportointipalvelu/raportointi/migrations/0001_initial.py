...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('kysymysryhmaid', models.ForeignKey(db_column='kysymysryhmaid', on_delete=django.db.models.deletion.DO_NOTHING, serialize=False, to='raportointi.kysymysryhma')),
                ('jarjestys', models.IntegerField(blank=True, null=True)),
                ('luotuaika', models.DateTimeField(auto_now_add=True)),
                ('muutettuaika', models.DateTimeField(auto_now=True)),
                ('kyselyid', models.ForeignKey(db_column='kyselyid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='kysymysryhmat', to='raportointi.kysely')),
                ('luotu_kayttaja', models.ForeignKey(db_column='luotu_kayttaja', on_delete=django.db.models.deletion.DO_NOTHING, to='raportointi.kayttaja')),
