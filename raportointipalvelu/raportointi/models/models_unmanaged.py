...
class KyselyKysymysryhma(models.Model):
    kyselyid = models.ForeignKey(
        Kysely, models.DO_NOTHING, db_column='kyselyid', related_name='kysely', primary_key=True)
    kysymysryhmaid = models.ForeignKey('Kysymysryhma', models.DO_NOTHING, db_column='kysymysryhmaid')
...
class KysymysJatkokysymys(models.Model):
    ...
    jatkokysymysid = models.ForeignKey(
        Kysymys, models.DO_NOTHING, db_column='jatkokysymysid', related_name='kysymysjatkokysymys_jatkokysymysid', primary_key=True)
    ...
    class Meta:
        ...
        unique_together = (('kysymysid', 'jatkokysymysid'),)
...
class AluejakoAlue(models.Model):
    id = models.AutoField(primary_key=True)
