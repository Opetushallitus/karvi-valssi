...
from raportointi.migrations.testing.setup import (
    ...
    add_testing_responses_kayttooikeus_paakayttaja2_ok, add_testing_responses_kayttooikeus_impersonate_paakayttaja_ok,
...
class AnswersExportTests(TestCase):
    ...
    @responses.activate
    def test_get_answers_export_yllapitaja_impersonate_org_ok(self):
    ...
    @responses.activate
    def test_get_answers_export_yllapitaja_impersonate_org_fail(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
            ...
            f"kysymysryhmaid={kysymysryhma.pk}/koulutustoimija={kysely.koulutustoimija.oid}/"
            f"alkupvm={kysely.voimassa_alkupvm}/",
            HTTP_IMPERSONATE_ORGANIZATION="0.1.22")
        self.assertEqual(resp.status_code, status.HTTP_403_FORBIDDEN)
        self.assertTrue("ER011" in str(resp.json()))

    @responses.activate
    def test_get_answers_export_impersonate_paakayttaja_ok(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
    ...
    @responses.activate
    def test_get_answers_export_impersonate_toteuttaja_fail(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
    ...
    @responses.activate
    def test_get_answers_export_paakayttaja_ok(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
    ...
    @responses.activate
    def test_get_answers_export_paakayttaja2_no_permission_fail(self):
        add_testing_responses_kayttooikeus_paakayttaja2_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
            f"{RAPORTOINTIPALVELU_API_URL}/answers-export/"
    ...
    @responses.activate
    def test_get_answers_export_toteuttaja_no_permission_fail(self):
    ...
    @responses.activate
    def test_get_answers_export_yllapitaja_no_permission_fail(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
    ...
    def test_get_answers_export_kysely_not_found(self):
        ...
        resp = self.client.get(
            f"{RAPORTOINTIPALVELU_API_URL}/answers-export/"
            f"kysymysryhmaid=1/koulutustoimija={kysely.koulutustoimija.oid}/alkupvm=2000-01-01/")
    ...
    @responses.activate
    def test_get_answers_export_palautekysely_yllapitaja_ok(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
            f"{RAPORTOINTIPALVELU_API_URL}/answers-export/"
            f"kysymysryhmaid={kysymysryhma.pk}/"
            f"alkupvm1={kysely.voimassa_alkupvm}/alkupvm2={kysely.voimassa_alkupvm}/"
            "?is_siirto=true")
        self.assertEqual(resp.status_code, status.HTTP_200_OK)

    @responses.activate
    def test_get_answers_export_palautekysely_paakayttaja_no_permission_fail(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
    ...
    @responses.activate
    def test_get_answers_export_palautekysely_toteuttaja_no_permission_fail(self):
        add_testing_responses_kayttooikeus_toteuttaja_ok(responses)
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="reportview_kysymysryhma")
        kysely = Kysely.objects.get(nimi_fi="viewreport1")
        resp = self.client.get(
