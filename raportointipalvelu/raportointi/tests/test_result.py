...
from raportointi.migrations.testing.setup import (
    ...
    add_testing_responses_kayttooikeus_impersonate_paakayttaja_ok, add_testing_responses_kayttooikeus_toteuttaja_ok)
...
class ResultPostTests(TestCase):
    ...
    @responses.activate
    def test_post_result_kysely_not_ended_fail(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely5")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma5")
        post_data = {
            "kysymysryhmaid": kysymysryhma.kysymysryhmaid,
            "koulutustoimija": kysely.koulutustoimija.oid,
            "kysely_voimassa_alkupvm": kysely.voimassa_alkupvm,
    ...
    @responses.activate
    def test_post_result_laatutekija_fail(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely9")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma9")
        post_data = {
            "kysymysryhmaid": kysymysryhma.kysymysryhmaid,
            "koulutustoimija": kysely.koulutustoimija.oid,
            "kysely_voimassa_alkupvm": kysely.voimassa_alkupvm,
...
class ResultGetTests(TestCase):
    ...
    @responses.activate
    def test_get_result_toteuttaja_ok(self):
    ...
    @responses.activate
    def test_get_result_no_permission_as_toteuttaja_fail(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma1")
    ...
    def test_get_result_as_toteuttaja_koulutustoimija_oppilaitos_not_match_fail(self):
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma1")
        ...
        resp = self.client.get(f"{RAPORTOINTIPALVELU_API_URL}/result/"
                               ...
                               f"?oppilaitos=9.9.9")
        self.assertEqual(resp.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertTrue("ER028" in str(resp.json()))

    @responses.activate
    def test_get_result_inactive_kysely_not_found_fail(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
...
class ResultGetPdfTests(TestCase):
    ...
    @responses.activate
    def test_get_result_pdf_paakayttaja_ok(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma1")
        result = Result.objects.get(
    ...
    @responses.activate
    def test_get_result_pdf_yllapitaja_ok(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma1")
        result = Result.objects.get(
    ...
    @responses.activate
    def test_get_result_pdf_toteuttaja_ok(self):
        add_testing_responses_kayttooikeus_toteuttaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        kysymysryhma = Kysymysryhma.objects.get(nimi_fi="summary_testikysymysryhma1")
        result = Result.objects.get(
...
class ResultCsvExportTests(TestCase):
    databases = TEST_DATABASES
    ...
    @responses.activate
    def test_get_results_yllapitaja_csv_ok(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        resp = self.client.get(
            f"{RAPORTOINTIPALVELU_API_URL}/result/csv/kysymysryhmaid={kysely.kysymysryhmat.first().kysymysryhmaid}/"
            f"pvm1={kysely.voimassa_loppupvm}/pvm2=2040-01-01/"
        )
        self.assertEqual(resp.status_code, status.HTTP_200_OK)

    @responses.activate
    def test_get_results_yllapitaja_csv_base64_ok(self):
        add_testing_responses_kayttooikeus_yllapitaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        resp = self.client.get(
            f"{RAPORTOINTIPALVELU_API_URL}/result/csv/kysymysryhmaid={kysely.kysymysryhmat.first().kysymysryhmaid}/"
    ...
    @responses.activate
    def test_get_results_yllapitaja_csv_no_permission(self):
        add_testing_responses_kayttooikeus_paakayttaja_ok(responses)
        kysely = Kysely.objects.get(nimi_fi="summary_testikysely1")
        resp = self.client.get(
            f"{RAPORTOINTIPALVELU_API_URL}/result/csv/kysymysryhmaid={kysely.kysymysryhmat.first().kysymysryhmaid}/"
