...
function VirkailijaNavigaatio() {
    ...
    return (
        <nav>
            ...
            <div className={styles.navlinks} role="navigation" aria-label={t('valikko')}>
                ...
                <GuardedNavigaatio roles={allowedRoles.aluejako}>
                    <NavLink to={{pathname: '/aluejako'}} className={isNavActive}>
                        {t('aluejako')}
                    </NavLink>
                </GuardedNavigaatio>
            </div>
