...
function FormFieldActions({
    ...
    const reportOffIcon = (
        <Icon
            aria-label="report-off-icon"
            className="icon-button"
            title={t('piilotettu-raportilta-ja-csv-tiedostosta')}
        >
            <ReportOff />
        </Icon>
    );
        ...
        <div className={styles['icon-buttons']}>
            ...
            >
                ...
                <Grid container item direction={{xs: 'column'}}>
                    ...
                    {kysely.kysymykset?.find(
                        (kysymys) =>
                            kysymys.id === kysymysId &&
                            kysymys.metatiedot?.is_hidden_on_report === true,
                    ) ? (
                        <Grid item>{reportOffIcon}</Grid>
                    ) : (
                        <></>
                    )}
                </Grid>
