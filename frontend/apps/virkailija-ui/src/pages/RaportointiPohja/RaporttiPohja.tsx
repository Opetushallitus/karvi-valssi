...
import DropdownField from '@cscfi/shared/components/Form/FormFields/DropdownField/DropdownField';
...
function RaporttiPohja({
    ...
    const [matrixTypes] = useObservableState(() => virkailijapalveluGetMatrixScales$());
