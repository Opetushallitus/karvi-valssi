from kyselyt.models import (
    ...
    Monivalintavaihtoehto, Kysymysryhma, TilaEnum, KyselyKysymysryhma, Organisaatio, KysymysJatkokysymys)


# managed
vastauspalvelu_models = (Vastaaja, Vastaus, VastausSend, TempVastaus, FailedTaustatiedot)
