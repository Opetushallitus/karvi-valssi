...
from vastauspalvelu.filters import DisableLoggingInTestingFilter, AddProgramnameFilter
...
def get_test_db_name():
    ...
    return "aa_vast_" + md5.hexdigest()[:8]
...
LOCALISATION_ENDPOINT = f"{VIRKAILIJAPALVELU_URL}/api/v1/localisation"
