...
(defn poista-kysymyksen-jatkokysymysliitokset! [tx kysymysid]
  (db/poista-kysymyksen-jatkokysymysliitokset! tx {:kysymysid kysymysid}))

(defn poista-jatkokysymysliitos! [tx liitos-data]
  (db/poista-jatkokysymysliitos! tx liitos-data))

(defn jatkokysymysliitos-olemassa! [tx kysymysid jatkokysymysid vastaus]
  (:exists (db/jatkokysymysliitos-olemassa! tx {:kysymysid kysymysid :jatkokysymysid jatkokysymysid :vastaus vastaus})))
...
(defn hae-kysymys
  ...
  ([tx kysymysid]
   (db/hae-kysymys tx {:kysymysid kysymysid})))
