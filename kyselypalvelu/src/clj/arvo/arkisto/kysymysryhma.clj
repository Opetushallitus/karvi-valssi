...
(defn taydenna-kysymysryhma [kysymysryhma]
  (let [kysymykset (db/hae-kysymysryhman-kysymykset {:kysymysryhmaid (:kysymysryhmaid kysymysryhma)})
        ...
        jatkokysymykset (group-by :jatkokysymys_kysymysid kysymykset)
    ...
    ;(log/info "taydenna-kysymysryhma json" (json/generate-string kys {:pretty true}) )
...
(defn ^:private aseta-tila-julkaistu!
  [kysymysryhmaid]
  (db/aseta-kysymysryhman-tila-julkaistu! {:kysymysryhmaid kysymysryhmaid :kayttaja (:oid *kayttaja*)})
  (hae kysymysryhmaid))

(defn julkaise!
  [kysymysryhmaid]
  (when (julkaistavissa? kysymysryhmaid)
    (aseta-tila-julkaistu! kysymysryhmaid)))
