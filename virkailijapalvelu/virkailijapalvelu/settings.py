...
from virkailijapalvelu.filters import DisableLoggingInTestingFilter, AddProgramnameFilter
...
def get_test_db_name():
    ...
    return "aa_virk_" + md5.hexdigest()[:8]
...
LOCALISATION_NAMESPACE = "valssi"
LOCALISATION_LOCALES = ["fi", "sv", "en"]
