...
router_v1.register(r"aluejako", views.AluejakoViewSet, basename="aluejako")
...
urlpatterns = [
    path(settings.BASE_URL, include([
        ...
        path("api/v1/getpermission/", views.GetPermissionViewSet.as_view()),
        path("api/v1/localisation/", views.LocalisationViewSet.as_view()),
        ...
        path("ui-logs/", views.VirkailijaUILoggingViewSet.as_view()),
