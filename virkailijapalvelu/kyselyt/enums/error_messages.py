...
class ErrorMessages(enum.Enum):
    ...
    VA010 = get_error_dict("VA010", "'voimassa_loppupvm' can't be earlier than current date.")
    VA011 = get_error_dict("VA011", "Language code is not allowed within Kysymysryhma.")
    ...
    ER022 = get_error_dict("ER022", "Kysymysryhma tila is not 'julkaistu'.")
    ER023 = get_error_dict("ER023", "Kysymysryhma tila is not 'lukittu'.")
    ER024 = get_error_dict("ER024", "Organisaatio not found.")
    ER025 = get_error_dict("ER025", "Maximum Aluejako alue count exceeded. ({})")
    ER026 = get_error_dict("ER026", "AluejakoAlue not found.")
    ER027 = get_error_dict("ER027", "No YLLAPITAJA, PAAKAYTTAJA, or adequate TOTEUTTAJA permission.")
