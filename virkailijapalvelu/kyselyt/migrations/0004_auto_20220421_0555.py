# Generated by Django 3.2.10 on 2022-04-21 05:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kyselyt', '0003_ophauthentication'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tyyppi', models.TextField(blank=True, null=True)),
                ('kyselykertaid', models.ForeignKey(db_column='kyselykertaid', on_delete=django.db.models.deletion.DO_NOTHING, to='kyselyt.kyselykerta')),
                ('vastaajatunnusid', models.OneToOneField(db_column='vastaajatunnusid', on_delete=django.db.models.deletion.DO_NOTHING, to='kyselyt.vastaajatunnus')),
            ],
            options={
                'db_table': 'vastaaja',
                'managed': settings.TESTING,
